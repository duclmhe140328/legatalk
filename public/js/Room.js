...
async function whoAreYou() {
    ...
    Swal.fire({
        ...
        input: 'text',
        inputPlaceholder: 'Enter your email or names',
        inputAttributes: { maxlength: 254, id: 'usernameInput' },
        inputValue: default_name,
        html: initUser, // Inject HTML
        confirmButtonText: `Launch your video conference in seconds.`,
...
function showAbout() {
    ...
    Swal.fire({
        ...
        title: BRAND.about?.title && BRAND.about.title.trim() !== '' ? BRAND.about.title : 'WebRTC SFU v1.9.87',
        html: `
            <br />
            <div id="about">
                ${
